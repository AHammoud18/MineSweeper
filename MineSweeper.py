...
class MineSweeper():
    ...
    def removeTile(self, k:int = 0, t:ctk.CTkButton = None):
        ...
        t.configure(False, fg_color='transparent', hover=False, text=f'{k}' if k>0  else '', text_color=colors[k], font=ctk.CTkFont(family="Helvetica", size=16, weight="bold"))
